...
pkg_scaffolding_python2_pip_name="${pkg_scaffolding_python2_pip_name:-$pkg_name}"
# Name of python package to add to the build and runtime deps.
scaffolding_python2_pkg="core/python"
...
_pip_install_only() {
  scaffolding_python2_pip_only="true"
...
scaffolding_python2_install() {
  if [[ -n "$scaffolding_python2_pip_only" ]]; then
    scaffolding_python2_pip_install "$pkg_scaffolding_python2_pip_name" "$pkg_version"
  else
